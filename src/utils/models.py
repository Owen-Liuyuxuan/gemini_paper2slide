...
class PaperAnalysisSchema(BaseModel):
    ...
    core_philosophy: str = Field(description="The current state of the research problem, the motivation to discover the improvement and the overall workflow of the work")
    mathematical_formulation: str = Field(description="Mathematical formulation of the research question and the proposed solution")
    methodology: str = Field(description="Research methodology description, including the core algorithms and methods used")
    key_contributions: List[str] = Field(min_items=1, description="Key contributions of the paper")
    recommended_slide_count: int = Field(ge=5, le=25, description="Recommended number of slides for presenting the paper with enough information and details")
    visual_theme: str = Field(description="Describe the suggested visual theme for the presentation. Including color usage and design instructions for creating the visual theme.")
